    ...
    <div>
      <div class="relative h-auto w-auto ">
        ...
        <div class="absolute top-[6rem] md:top-32 lg:top-55 px-5 py-2 w-full md:1/2 lg:w-3/4   ">
          ...
          <button onClick={() => { navigate("/search") }} type="submit" class="focus:outline-none  text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-3xl text-lg md:text-lg lg:text-xl px-4 md:px-5  py-2 md:py-2.5 mt-4 md:mt-4 md:mb-2 ms-2 me-2  dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"> Find Blood </button>
